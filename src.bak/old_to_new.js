                ...
                for (let k = 0; k < items.length; k++) {
                    ...
                    let newobj = {
                        ...
                        "archiveData": {
                            ...
                            "filePath": path.join(item.archivePath, `${item.modify}-[${item.labels.join(",")}]-${item.md5}-${item.archiveName}`),
                            "fileName": `${item.modify}-[${item.labels.join(",")}]-${item.md5}-${item.archiveName}`,
